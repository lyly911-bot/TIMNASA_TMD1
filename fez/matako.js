...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://files.catbox.moe/d5s4n1.jpg"; // Full image URL
    const smallThumbnailUrl = "https://files.catbox.moe/d5s4n1.jpg"; // Small thumbnail URL
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `💦 Message from: ${contactName}\nɪᴛ ᴋᴀᴊᴜ ɪs ᴀʟɪᴠᴇ ɴᴏᴡ ᴀɴᴅ`, // Your contact in WhatsApp status format
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `🌟 Message from: ${contactName}\n🔥 ɪᴛ ᴋᴀᴊᴜ ᴡᴀᴛsᴀᴘᴘ ʙᴏᴛ 🔥`, // Your contact in WhatsApp status format
            body: "Yoh don't disturb am active🥱 Tap here",
            thumbnailUrl: smallThumbnailUrl, // Small thumbnail displayed below
            mediaType: 1, // Indicate this is an image
            renderLargerThumbnail: true, // Ensure thumbnail is displayed in full
