...
const { delay, loading, react } = require("../timnasa/utils");
...
// bug database
const { bugtext1 } = require("../timnasa/Bug/bugtext1");
const { bugtext2 } = require("../timnasa/Bug/bugtext2");
const { bugtext3 } = require("../timnasa/Bug/bugtext3");
const { bugtext4 } = require("../timnasa/Bug/bugtext4");
const { bugtext5 } = require("../timnasa/Bug/bugtext5");
const { bugtext6 } = require("../timnasa/Bug/bugtext6");
const { bugpdf } = require("../timnasa/Bug/bugpdf.js");
    ...
    async (dest, zk, commandOptions) => {
        ...
        const bug = {
            orderMessage: {
                ...
                sellerJid: "255756469954@s.whatsapp.net",
