...
timoth({ nomCom: "dev", categorie: "General", reaction: "⭐" }, async (dest, zk, commandeOptions) => {  
    ...
    let message = "WELCOME TO TIMNASA TMD HELP CENTER! ASK FOR HELP FROM THE DEVELOPER BELOW:\n\n";  
...
zokou({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {  
    ...
    await zk.sendMessage(auteurMessage, { text: `THANK YOU FOR CHOOSING TIMNASA-TMD, MAKE SURE YOU FOLLOW THESE LINKS.` }, { quoted: ms });  
});
